...
/**
 * The ledger's top bar (design/ 1a: "THU 27 AUG · WEEK 35"), plus the one
 * piece of chrome the mockups don't need but the app does: adding a habit.
 */
export function LedgerHeader({ label, onNewHabit }: LedgerHeaderProps) {
